            ...
            <div class="table-responsive">
                <form action="./vnpay_create_payment.php" id="create_form" method="post">       
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="order_id" name="order_id" type="text" value="<?php echo $_SESSION['ID_giohang']=rand(1111,9999)?>"/>
                    </div>
                    <div class="form-group">
                        <label for="amount">Số tiền</label>
                        <input class="form-control" id="amount"
                               name="amount" type="number" value="<?php echo $_SESSION['thanhtoan']?>"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txt_billing_fullname"
                               name="txt_billing_fullname" type="text" value="<?php echo $_SESSION['tenkhachhang']?>"/>             
                    </div>
                    <div class="form-group">
                        <label >Email (*)</label>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txt_billing_mobile"
                               name="txt_billing_mobile" type="text" value="<?php echo $_SESSION['sdt']?>"/>   
                    </div>
                    <div class="form-group">
                        <label >Địa chỉ (*)</label>
                        <input class="form-control" id="txt_billing_addr1"
                               name="txt_billing_addr1" type="text" value="<?php echo $_SESSION['diachi']?>"/>   
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txt_inv_customer"
                               name="txt_inv_customer" type="text" value="<?php echo $_SESSION['tenkhachhang']?>"/>
                    </div>
                    <div class="form-group">
                        <label >Công ty</label>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txt_inv_addr1"
                               name="txt_inv_addr1" type="text" value="<?php echo $_SESSION['diachi']?>"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txt_inv_mobile"
                               name="txt_inv_mobile" type="text" value="<?php echo $_SESSION['sdt']?>"/>
                    </div>
